[![Build Status](https://dev.azure.com/xecta/Python_Flask_Server/_apis/build/status/faceit1.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/xecta/Python_Flask_Server/_build/latest?definitionId=27&branchName=master)
